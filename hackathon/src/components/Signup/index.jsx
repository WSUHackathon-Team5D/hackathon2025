                    ...
                    <div className="container">
                        ...
                        <form className="signup_form" onSubmit={handleSubmit}>
                            ...
                            <div className="terms_container">
                                ...
                                />
                                <span className='desc'>I accept the <Link to='/privacy'>Privacy Policy</Link> and the <Link to='/terms'>Terms of Service</Link></span>
                            </div>
                            <input
                                type="submit"
                        ...
                        <div className="signup_footer">Have an account? <Link to='/login'>Log in Now</Link></div>
                    </div>
                </div>
            </div>
        </Fragment>
